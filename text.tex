...
Man sieht, dass die Funktion \(\mathcal P(\R) \longrightarrow [0,1], U \mapsto \Pro(X \in U)\) ein W'maß für den Eventraum \((\R, \mathcal P(\R))\) ergibt gegeben der ZV \(X\) und dem diskretem Eventraum \((\Omega, \mathcal P(\Omega), \Pro)\). \\ Diese Funktion nennen wir Verteilung von \(X\). \\ \\
\text{\scshape Träger} \\
...
\subsubsubsection{Summe unabhängiger Bernoulli-ZV}{
